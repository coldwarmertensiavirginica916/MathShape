...
public struct CardioidHeartShape: ParametricShape {
...
public extension SwiftUI.Shape where Self == CardioidHeartShape {
    static var cardioidHeart: Self { .init() }
}

#Preview {
    ParametricShapePreview(shape: .cardioidHeart)
}
